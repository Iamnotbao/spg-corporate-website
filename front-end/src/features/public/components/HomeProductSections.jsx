...
export default function HomeProductSections() {
  ...
  return <>
    <section className="home-section home-product-video" aria-labelledby="home-video-title"><div className="public-container home-product-video__grid"><div><p className="public-eyebrow">Học bằng ngữ cảnh</p><h2 id="home-video-title">Xem và nối kiến thức vào bài học.</h2><p>Video nổi bật chạy tự động, lặp liên tục và luôn tắt tiếng để tạo chuyển động nhẹ cho trang mà không làm gián đoạn việc học.</p><Link className="text-link" to="/videos">Xem thư viện video <span aria-hidden="true">→</span></Link></div><div className="home-product-video__player">{video ? <VideoPlayer video={video} title={`Video nổi bật: ${video.title}`} /> : <div className="home-product-video__placeholder"><span lang="zh-Hans">影</span><strong>Video Hanyora nổi bật</strong><small>Admin có thể chọn một video đã xuất bản cho khu vực này.</small></div>}</div></div></section>
