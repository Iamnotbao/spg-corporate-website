...
router.get("/permissions", requirePermission("users.read"), accountController.listPermissions);

router.get("/users", requirePermission("users.read"), asyncHandler(accountController.listUsers));
router.post("/users", requirePermission("users.create"), asyncHandler(accountController.createUser));
router.put("/users/:id", requirePermission("users.update"), asyncHandler(accountController.updateUser));
router.delete("/users/:id", requirePermission("users.delete"), asyncHandler(accountController.deleteUser));

router.get("/categories", requirePermission("categories.read"), asyncHandler(categoryController.listCategories));
...
router.get("/communications/notifications", requirePermission("communications.read"), asyncHandler(communicationsController.listNotifications));
