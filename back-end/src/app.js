...
import adminTrashRoutes from "./routes/admin-trash.routes.js";
import adminTrashOverrideRoutes from "./routes/admin-trash-overrides.routes.js";
import adminVocabularyRoutes from "./routes/admin-vocabulary.routes.js";
import lessonVocabularyRoutes from "./routes/lesson-vocabulary.routes.js";
...
app.use("/api/admin", adminTrashOverrideRoutes);
app.use("/api/admin", adminRoutes);
app.use("/api/student", studentRoutes);
app.use("/api/lesson-vocabulary", lessonVocabularyRoutes);
